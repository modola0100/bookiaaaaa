...
class GovList {
  ...
  GovList({required this.id, required this.governorateNameEn});

  factory GovList.fromJson(Map<String, dynamic> json) {
    return GovList(id: json['id'], governorateNameEn: json["governorate_name_en"]);
  }
}

List<GovList> governoarateList = list.map((e) => GovList.fromJson(e)).toList();
